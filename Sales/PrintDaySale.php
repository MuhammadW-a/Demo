<?php
    ...
    function fetch_data() {  
        ...
        $sql2 = "SELECT * FROM sales_profit WHERE Datee = '$date'";
    ...
    $obj_pdf->SetTitle("Sales Report Of Day");  
...
$date = file_get_contents('date_to_check_sale.txt');
    $content .= '  
    <h3 align="center">Sales Report For Day : '.$date.'</h3><br /><br />  
